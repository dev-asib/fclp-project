class AppConstants{
  ...
  static RegExp mobileNumberRegExp = RegExp(
      r'^(?:\+?88)?01[3-9]\d{8}$'
  );

  static RegExp withdrawNumberRegExp = RegExp(
      r'^(01[3-9]\d{8})$'
  );

  static RegExp withdrawAmountRegExp = RegExp(
      r'^(100|[1-9][0-9]{2,})$'
  );
  ...
  static RegExp addressRegExp = RegExp(
     r'^[a-zA-Z0-9\s,.-]+$'
  );
