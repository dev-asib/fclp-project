...
class AirTicketController extends ChangeNotifier {
  List<Map<String, String>> airports = [
    {'place': 'Dhaka', 'airport': 'DHK (Dhaka International Airport)'},
    {'place': 'Chittagong', 'airport': 'CTS (Shash Amanat International Airport)'},
    {'place': 'Sylhet', 'airport': 'ZYL (Osmani International Airport)'},
    {'place': 'Cox\'s Bazar', 'airport': 'CXB (Cox\'s Bazar International Airport)'},
    {'place': 'Saidpur', 'airport': 'SPD (Saidpur Airport)'},
    {'place': 'Rajshahi', 'airport': 'RJH (Rajshahi Airport)'},
  ];

  Map<String, String> selectedDepartureAirport = {};
  Map<String, String> selectedArrivalAirport = {};

  List<String> typeOfTicket = ["ইকোনমি", "বিজনেস", "প্রিমিয়াম", "ফার্স্ট ক্লাস"];
  String ticket = "ফার্স্ট ক্লাস";
  List<String> travellers = ["1 জন", "2 জন", "3 জন", "4 জন", "5 জন", "6 জন", "7 জন", "8 জন", "9 জন"];
